...
ggplot(obesity_train, aes(FAVC)) + geom_bar()
ggplot(obesity_train, aes(CAEC)) + geom_bar()
ggplot(obesity_train, aes(SMOKE)) + geom_bar()
ggplot(obesity_train, aes(SCC)) + geom_bar()
ggplot(obesity_train, aes(CALC)) + geom_bar()
ggplot(obesity_train, aes(MTRANS)) + geom_bar()
ggplot(obesity_train, aes(NObeyesdad)) + geom_bar()

#Does this serve the purpose?
pie(table(obesity_train$Gender))
pie(table(obesity_train$family_history_with_overweight))

```

```{r}
#ordinal variables
ggplot(obesity_train, aes(FCVC)) + geom_bar()
ggplot(obesity_train, aes(NCP)) + geom_bar()
ggplot(obesity_train, aes(CH2o)) + geom_bar()
ggplot(obesity_train, aes(FAF)) + geom_bar()
ggplot(obesity_train, aes(TUE)) + geom_bar()
